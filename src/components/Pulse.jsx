...
const Pulse = () => {
  return (
    <div className="min-h-screen pt-28 px-4 md:px-8 lg:px-12">
      ...
      <div className="relative mb-12 flex items-center flex-wrap md:flex-nowrap">
        ...
        <img src={h5} alt="Pulse Icon" className="w-16 md:w-24 h-auto mr-4 md:mr-6 ml-4" />
        <div className="relative z-10">
          <h1 className="absolute text-gray-300 text-6xl md:text-8xl font-bold -z-10 top-0 transform -translate-y-1/2">
            01
          </h1>
          <h2 className="text-2xl md:text-3xl font-bold text-red-600">Pulse-Life</h2>
          <p className="text-base md:text-lg text-gray-700">FUEL YOUR LIFE WITH ENERGY</p>
        </div>
      </div>
      
      {/* Images Section */}
      <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-6 mb-6">
        <img src={sample} alt="Pulse Sample" className="w-full md:w-1/2 h-auto rounded-lg shadow-md" />
        <img src={sample3} alt="Pulse Sample 3" className="w-full md:w-1/2 h-auto rounded-lg shadow-md" />
      </div>

      {/* Text Sections */}
      <div className="w-full text-gray-700 mb-12">
        {[
          {
          ...
          <div key={index} className="relative shadow-lg p-4 md:p-6 mb-6 rounded-lg bg-white flex flex-col md:flex-row">
            <div className="absolute left-0 w-1 h-14 bg-blue-900"></div> {/* Blue Line */}
            <div className="pl-4 md:pl-6">
              <span className="text-red-600 font-semibold text-lg">{section.title}</span><br />
      ...
      <footer className="bg-white p-6 text-center mt-16">
        <div className="container mx-auto">
          <p className="font-sans text-xs md:text-sm lg:text-base text-gray-700">&copy; {new Date().getFullYear()} Pulse Life. All rights reserved.</p>
          <div className="flex justify-center space-x-4 md:space-x-6 mt-3">
            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
              <FaInstagram className="text-red-600 hover:text-green-700" size={22} md:size={26} />
            </a>
            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
              <FaFacebook className="text-red-600 hover:text-green-700" size={22} md:size={26} />
            </a>
            <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
              <FaTwitter className="text-red-600 hover:text-green-700" size={22} md:size={26} />
            </a>
          </div>
        </div>
      </footer>
